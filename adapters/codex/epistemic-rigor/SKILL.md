...
Validate claims, handle uncertainty gracefully, and avoid hallucinated citations by rigorously linking assertions to evidence. This Codex adapter is intentionally thin and delegates real functionality to the shared core under `../../../core/epistemic-rigor`.
