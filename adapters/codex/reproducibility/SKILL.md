...
Capture local run context, verify current state against a saved context, reconstruct tracked runs, and diff reproducibility snapshots. This Codex adapter is intentionally thin and delegates real functionality to the shared core under `../../../core/reproducibility`.
