...
Author a hypothesis, run it through the v2 verifier, and read the paired-bootstrap report honestly. This Codex adapter is intentionally thin and delegates real functionality to the shared core under `../../../core/arxiver-verify-hypothesis`.
