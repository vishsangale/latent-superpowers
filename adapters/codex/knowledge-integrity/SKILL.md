...
Preserve the integrity of information by enforcing precise attribution, clarifying knowledge boundaries, and assessing cascading impacts. This Codex adapter is intentionally thin and delegates real functionality to the shared core under `../../../core/knowledge-integrity`.
