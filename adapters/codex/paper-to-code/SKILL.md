...
Turn paper summaries or method notes into implementation plans, repo gap maps, and evaluation checklists. This Codex adapter is intentionally thin and delegates real functionality to the shared core under `../../../core/paper-to-code`.
