...
# Research Meta-Critic

## Overview

Analyzes complete research run traces and proposes improvements to other agents' system prompts. This Codex adapter is intentionally thin and delegates real functionality to the shared core under `../../../core/research-meta-critic`.
