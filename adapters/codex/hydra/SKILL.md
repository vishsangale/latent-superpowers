...
Inspect, explain, and safely plan Hydra-based experiment configuration workflows. This Codex adapter is intentionally thin and delegates real functionality to the shared core under `../../../core/hydra`.
