---
name: arxiver-add-adapter
description: Use when adding a new benchmark to the v2 verifier — author the adapter class, register a BaselineSpec, and stage any required dataset.
---
...
Wrap a new benchmark in the v2 verifier and register a versioned baseline. This Codex adapter is intentionally thin and delegates real functionality to the shared core under `../../../core/arxiver-add-adapter`.
