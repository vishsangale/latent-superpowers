...
Inspect repo entrypoints for cluster readiness, generate sbatch scripts, convert local run manifests into job arrays, and summarize Slurm logs and sacct output. This Codex adapter is intentionally thin and delegates real functionality to the shared core under `../../../core/slurm-cluster`.
